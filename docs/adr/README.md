...
| [0021](0021-server-content-authority.md) | 档案权威在服务器 + 本机只上传 | Accepted（内核 + 本机控制台） | 2026-08-30 |
| [0022](0022-owner-credential-tiers.md) | 主人凭证分层（口令 vs 设备 / Agent） | Accepted（运行时已落地） | 2026-08-30 |
